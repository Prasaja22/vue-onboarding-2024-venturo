      ...
      <BRow>
        <BCol lg="6" md="12">
          ...
          <BForm class="form-horizontal" role="form">
            ...
            <BRow class="mb-3">
              <label class="col-md-2 col-form-label" for="form-category"
                >Kategori</label
              >
              <BCol md="10">
                <BFormSelect
                  ...
                  :class="{
                    'is-invalid': !!(
                      errorList && errorList.product_category_id
                    ),
                  }"
                  id="form-category"
                  :style="{
                    color:
                      formModel.product_category_id === '' ? '#7c8094' : '',
                  }"
                >
                  <BFormSelectOption :value="''" :disabled="true"
                    >Pilih Kategori</BFormSelectOption
                  >
                  <BFormSelectOption
                ...
                <template v-if="!!(errorList && errorList.product_category_id)">
                  <div
                    class="invalid-feedback"
                    v-for="(err, index) in errorList.product_category_id"
                    :key="index"
                  >
                    <span>{{ err }}</span>
                  </div>
            ...
            <BRow class="mb-3">
              ...
              <BCol md="10">
                <BFormSelect
                  ...
                  :style="{
                    color: formModel.is_available === '' ? '#7c8094' : '',
                  }"
                >
                  <BFormSelectOption :value="''" :disabled="true"
                    >Pilih Status</BFormSelectOption
                  >
            ...
            <BRow class="mb-3">
              ...
              <BCol md="10">
                <input
                  type="number"
                  class="form-control"
                  :class="{ 'is-invalid': !!(errorList && errorList.price) }"
                  id="form-name"
                ...
                <template v-if="!!(errorList && errorList.price)">
                  <div
                    class="invalid-feedback"
                    v-for="(err, index) in errorList.price"
                    :key="index"
                  >
                    <span>{{ err }}</span>
                  </div>
            ...
            <BRow class="mb-3">
              ...
              <BCol md="10">
                ...
                <template v-if="!!(errorList && errorList.description)">
                  <div
                    class="invalid-feedback"
                    v-for="(err, index) in errorList.description"
                    :key="index"
                  >
                    <span>{{ err }}</span>
                  </div>
                ...
                <BTr v-for="(detail, i) in details" :key="i">
                  ...
                  <BTh>
                    <input
                      ...
                      :class="{
                        'is-invalid': !!(
                          errorList && errorList[`details.${i}.description`]
                        ),
                      }"
                  ...
                  <BTh>
                    <BFormSelect
                      ...
                      :class="{
                        'is-invalid': !!(
                          errorList && errorList[`details.${i}.type`]
                        ),
                      }"
                    ...
                    >
                      ...
                      <BFormSelectOption value="Toping"
                        >Toping</BFormSelectOption
                      >
                    </BFormSelect>
                    <template
                      v-if="!!(errorList && errorList[`details.${i}.type`])"
                    >
                      <div
                        class="invalid-feedback"
                        v-for="(err, index) in errorList[`details.${i}.type`]"
                        :key="index"
                      >
                        <span>{{ err }}</span>
                      </div>
                  ...
                  <BTh>
                    <input
                      ...
                      :class="{
                        'is-invalid': !!(
                          errorList && errorList[`details.${i}.price`]
                        ),
                      }"
                      placeholder="Masukkan harga Add On"
                    />
                    <template
                      v-if="!!(errorList && errorList[`details.${i}.price`])"
                    >
                      <div
                        class="invalid-feedback"
                        v-for="(err, index) in errorList[`details.${i}.price`]"
                        :key="index"
                      >
                        <span>{{ err }}</span>
                      </div>
...
watch(
  ...
  (newFormModel) => {
    ...
    if (
      newFormModel.product_category_id &&
      errorList.value.product_category_id
    ) {
