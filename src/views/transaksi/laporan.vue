<template>
  <Layout>
    ...
    <BCard>
      <BRow>
        <BCol cols="12 overflow-scroll">
          <BTableSimple
            class="align-middle dt-responsive nowrap w-100 table-check table-bordered"
          >
            <BThead>
              <BTr>
                <BTh
                  ...
                  >Menu</BTh
                >
                <BTh :colspan="dateLength" style="text-align: center"
                  >Periode</BTh
                >
                <BTh
                  rowspan="2"
              ...
              <BTr>
                <BTh v-for="(seting, i) in reportSetting.dates" :key="i">{{
                  seting.slice(-2)
                }}</BTh>
              </BTr>
            </BThead>
            ...
            <BTbody v-for="category in reportData" :key="category.category_id">
              <BTr>
                <BTd :colspan="dateLength + 2" style="font-weight: bolder"
              ...
              <BTr v-for="product in category.products" :key="product">
                ...
                <BTd
                  v-for="transaksi in product.transactions"
                  :key="transaksi"
                  class="text-center"
